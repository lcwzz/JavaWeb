...
public abstract class BaseDAO<T> {
    ...
    //通用的增删改操作
    public int updateUniversal(String sql, Object... args) throws SQLException {
    ...
    //查询一条记录
    public T searchSingleRecord(String sql, Object... args) throws SQLException {
    ...
    //查询多条记录
    public List<T> searchMutipleRecord(String sql, Object... args) throws SQLException {
